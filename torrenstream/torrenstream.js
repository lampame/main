(function () {
    ...
    function startPlugin() {
      window.plugin_lmets_ready = true;
      Lampa.Manifest.plugins = {
        type: "video",
        version: "0.1",
        name: "LME Torrent stream",
        description: "Maybe we stream torrent)",
        component: "lmets"
      };
    ...
    if (!window.plugin_lmets_ready) startPlugin();
