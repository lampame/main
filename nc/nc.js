    ...
    function catSubmenu(type) {
      ...
      if (type === 'nc_subtv' || type === 'nc_newsubtv') {
        ...
        _field3.on("hover:enter", function () {
          Lampa.Select.show({
            title: Lampa.Lang.translate(type === 'nc_subtv' ? 'nc_subtv' : 'nc_newsubtv'),
            //items: items,
            items: items,
