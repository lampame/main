(function () {
    ...
    function changeParser() {
      ...
      Lampa.Storage.set('jackett_interview', settings.interview);
      Lampa.Storage.set('parse_in_search', settings.parse_in_search);
      Lampa.Storage.set('parse_lang', settings.parse_lang);
    }
