(function () {
  ...
  function _GetInfo$1() {
    _GetInfo$1 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee5() {
      var payload, shares, moviesPath, tvPath, matchingShare, _t4;
      return _regenerator().w(function (_context5) {
        while (1) switch (_context5.n) {
          case 0:
            _context5.p = 0;
          ...
          case 3:
            matchingShare = shares.find(function (share) {
              var sharePath = share.path;
              return isShareMatched(sharePath, moviesPath) || isShareMatched(sharePath, tvPath);
            });
            if (!(matchingShare && matchingShare.additional && matchingShare.additional.volume_status && typeof matchingShare.additional.volume_status.freespace !== 'undefined')) {
              _context5.n = 4;
              break;
            }
            return _context5.a(2, {
