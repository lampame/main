  ...
  */
  module.exports = function (options, source) {
    ...
    if (GLOBAL) {
      ...
      target = globalThis$9[TARGET] || defineGlobalProperty$1(TARGET, {});
    } else {
  ...
  var require$$0$5 = /*@__PURE__*/getAugmentedNamespace(_export);
  ...
  var globalThis$8 = /*#__PURE__*/Object.freeze({
    __proto__: null
  });

  var require$$0$4 = /*@__PURE__*/getAugmentedNamespace(globalThis$8);
  ...
  function requireFails () {
  	if (hasRequiredFails) return fails$9;
  	hasRequiredFails = 1;
  ...
  function requireRequireObjectCoercible () {
  	if (hasRequiredRequireObjectCoercible) return requireObjectCoercible$2;
  ...
  var exec$2 = require('../internals/regexp-exec');
  ...
  fixRegExpWellKnownSymbolLogic$1('replace', function (_, nativeReplace, maybeCallNative) {
    ...
    function replace(searchValue, replaceValue) {
      ...
      return replacer ? call$6(replacer, searchValue, O, replaceValue) : call$6(nativeReplace, toString$7(O), searchValue, replaceValue);
    },
    ...
    function (string, replaceValue) {
      ...
      var flags = toString$7(getRegExpFlags$3(rx));
  ...
  var SyntaxError = globalThis$7.SyntaxError;
  var exec$1 = uncurryThis$9(RegExpPrototype$1.exec);
  ...
  var BASE_FORCED = DESCRIPTORS$5 && (!CORRECT_NEW || MISSED_STICKY || UNSUPPORTED_DOT_ALL || UNSUPPORTED_NCG || fails$7(function () {
    re2[MATCH] = false;
  ...
  if (isForced('RegExp', BASE_FORCED)) {
    ...
    defineBuiltIn$4(globalThis$7, 'RegExp', RegExpWrapper, {
      constructor: true
    });
  }
  ...
  var toString$5 = uncurryThis$8(1.1.toString);
  ...
  if (DESCRIPTORS$4 && isCallable$7(NativeSymbol) && (!('description' in SymbolPrototype$1) ||
  // Safari 12 bug
  NativeSymbol().description !== undefined)) {
    ...
    SymbolWrapper['for'] = {
      'for': function _for(key) {
        ...
        var symbol = call$5(nativeFor, this, stringKey);
    ...
    var thisSymbolValue = uncurryThis$7(SymbolPrototype$1.valueOf);
    var symbolDescriptiveString = uncurryThis$7(SymbolPrototype$1.toString);
    var regexp = /^Symbol\((.*)\)[^)]+$/;
  ...
  var $Symbol = globalThis$4.Symbol;
  var SymbolPrototype = $Symbol && $Symbol[PROTOTYPE];
  var RangeError = globalThis$4.RangeError;
  var TypeError$1 = globalThis$4.TypeError;
  var QObject = globalThis$4.QObject;
  ...
  var $defineProperties = function defineProperties(O, Properties) {
    ...
    $forEach(keys, function (key) {
      if (!DESCRIPTORS$3 || call$4($propertyIsEnumerable, properties, key)) $defineProperty$1(O, key, properties[key]);
    });
    return O;
  };
  ...
  if (!NATIVE_SYMBOL$2) {
    $Symbol = function _Symbol() {
      ...
      var _setter = function setter(value) {
        var $this = this === undefined ? globalThis$4 : this;
        if ($this === ObjectPrototype) call$4(_setter, ObjectPrototypeSymbols, value);
  ...
  var isCallable$6 = /*#__PURE__*/Object.freeze({
    __proto__: null
  });

  var require$$0$3 = /*@__PURE__*/getAugmentedNamespace(isCallable$6);

  var getBuiltIn$2;
  var hasRequiredGetBuiltIn;

  function requireGetBuiltIn () {
  	if (hasRequiredGetBuiltIn) return getBuiltIn$2;
  	hasRequiredGetBuiltIn = 1;

  	var globalThis = require$$0$4;
  	var isCallable = require$$0$3;
  ...
  var toString$3 = uncurryThis$5({}.toString);
  ...
  var require$$2$4 = /*@__PURE__*/getAugmentedNamespace(classofRaw);

  var classof$3;
  var hasRequiredClassof;

  function requireClassof () {
  	if (hasRequiredClassof) return classof$3;
  	hasRequiredClassof = 1;

  	var TO_STRING_TAG_SUPPORT = requireToStringTagSupport();
  	var isCallable = require$$0$3;
  	var classofRaw = require$$2$4;
  	...
  	classof$3 = TO_STRING_TAG_SUPPORT ? classofRaw : function (it) {
  	  var O, tag, result;
  ...
  var stringifyWithProperSymbolsConversion = WRONG_SYMBOLS_CONVERSION ? function (it, replacer) {
    ...
    args[1] = function (key, value) {
      ...
      if (isCallable$4($replacer)) value = call$3($replacer, this, $String$2(key), value);
  ...
  var getReplacerFunction = function getReplacerFunction(replacer) {
    ...
    for (var i = 0; i < rawLength; i++) {
      ...
      if (typeof element == 'string') push$1(keys, element);else if (typeof element == 'number' || classof$2(element) === 'Number' || classof$2(element) === 'String') push$1(keys, toString$1(element));
    }
  ...
  if ($stringify) $$6({
    ...
    stringify: function stringify(text, replacer, space) {
      ...
      var json = stringifyWithProperSymbolsConversion(text, function (key, value) {
        // some old implementations (like WebKit) could pass numbers as keys
        var v = isCallable$4(replacerFunction) ? call$3(replacerFunction, this, $String$2(key), value) : value;
  ...
  var $String$1 = globalThis$3.String;

  // eslint-disable-next-line es/no-object-getownpropertysymbols -- required for testing
  module.exports = !!Object.getOwnPropertySymbols && !fails$3(function () {
  ...
  fixRegExpWellKnownSymbolLogic('split', function (SPLIT, nativeSplit, maybeCallNative) {
    ...
    function split(separator, limit) {
      ...
      return splitter ? call$2(splitter, separator, O, limit) : call$2(internalSplit, toString(O), separator, limit);
    },
  ...
  exports.f = DESCRIPTORS$2 ? $getOwnPropertyDescriptor$1 : function getOwnPropertyDescriptor(O, P) {
    O = toIndexedObject(O);
    P = toPropertyKey$1(P);
  ...
  module.exports = function (it) {
    return _typeof(it) == 'object' ? it !== null : isCallable$3(it);
  };
  ...
  var require$$2$2 = /*@__PURE__*/getAugmentedNamespace(isObject);
  ...
  module.exports = isCallable$2(WeakMap) && /native code/.test(String(WeakMap));
  ...
  var require$$2$1 = /*@__PURE__*/getAugmentedNamespace(makeBuiltIn$1);
