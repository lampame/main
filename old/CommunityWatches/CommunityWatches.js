(function () {
  ...
  */
  ...
  var require$$3$4 = /*@__PURE__*/getAugmentedNamespace(globalThis$e);
  ...
  fixRegExpWellKnownSymbolLogic$2('replace', function (_, nativeReplace, maybeCallNative) {
    ...
    function replace(searchValue, replaceValue) {
      ...
      return replacer ? call$a(replacer, searchValue, O, replaceValue) : call$a(nativeReplace, toString$8(O), searchValue, replaceValue);
    },
  ...
  if (isForced$2('RegExp', BASE_FORCED)) {
    ...
    defineBuiltIn$6(globalThis$d, 'RegExp', RegExpWrapper, {
      constructor: true
    });
  }
  ...
  if (DESCRIPTORS$8 && isCallable$b(NativeSymbol) && (!('description' in SymbolPrototype$1) ||
  // Safari 12 bug
  ...
  for (var COLLECTION_NAME$1 in DOMIterables$1) {
    if (DOMIterables$1[COLLECTION_NAME$1]) {
      handlePrototype$1(globalThis$b[COLLECTION_NAME$1] && globalThis$b[COLLECTION_NAME$1].prototype);
    }
  }
  ...
  var $Symbol = globalThis$a.Symbol;
  var SymbolPrototype = $Symbol && $Symbol[PROTOTYPE];
  var RangeError = globalThis$a.RangeError;
  var TypeError$3 = globalThis$a.TypeError;
  var QObject = globalThis$a.QObject;
  ...
  var $defineProperty$1 = function defineProperty(O, P, Attributes) {
    ...
    if (hasOwn$4(AllSymbols, key)) {
      ...
      if (!('enumerable' in Attributes) ? !hasOwn$4(O, key) || hasOwn$4(O, HIDDEN) && O[HIDDEN][key] : !Attributes.enumerable) {
        if (!hasOwn$4(O, HIDDEN)) nativeDefineProperty(O, HIDDEN, createPropertyDescriptor$3(1, nativeObjectCreate(null)));
        O[HIDDEN][key] = true;
      } else {
  ...
  if (!NATIVE_SYMBOL$2) {
    $Symbol = function _Symbol() {
      ...
      var _setter = function setter(value) {
        var $this = this === undefined ? globalThis$a : this;
  ...
  module.exports = function (it) {
    return stringSlice$4(toString$4(it), 8, -1);
  };
  ...
  var require$$0$6 = /*@__PURE__*/getAugmentedNamespace(classofRaw);
  ...
  module.exports = USE_SYMBOL_AS_UID ? function (it) {
    ...
    return isCallable$9($Symbol) && isPrototypeOf$2($Symbol.prototype, $Object$1(it));
  };
  ...
  var stringifyWithProperSymbolsConversion = WRONG_SYMBOLS_CONVERSION ? function (it, replacer) {
    ...
    args[1] = function (key, value) {
      ...
      if (isCallable$8($replacer)) value = call$7($replacer, this, $String$2(key), value);
  ...
  var getReplacerFunction = function getReplacerFunction(replacer) {
    ...
    for (var i = 0; i < rawLength; i++) {
      ...
      if (typeof element == 'string') push$2(keys, element);else if (typeof element == 'number' || classof$5(element) === 'Number' || classof$5(element) === 'String') push$2(keys, toString$2(element));
    }
  ...
  if ($stringify) $$b({
    ...
    stringify: function stringify(text, replacer, space) {
      ...
      var json = stringifyWithProperSymbolsConversion(text, function (key, value) {
        // some old implementations (like WebKit) could pass numbers as keys
        var v = isCallable$8(replacerFunction) ? call$7(replacerFunction, this, $String$2(key), value) : value;
  ...
  fixRegExpWellKnownSymbolLogic$1('split', function (SPLIT, nativeSplit, maybeCallNative) {
    ...
    function split(separator, limit) {
      ...
      var splitter = isObject$3(separator) ? getMethod$1(separator, SPLIT) : undefined;
      return splitter ? call$6(splitter, separator, O, limit) : call$6(internalSplit, toString$1(O), separator, limit);
    },
  ...
  var require$$0$5 = /*@__PURE__*/getAugmentedNamespace(indexedObject);
  ...
  exports.f = DESCRIPTORS$6 ? $getOwnPropertyDescriptor$1 : function getOwnPropertyDescriptor(O, P) {
    ...
    if (hasOwn$3(O, P)) return createPropertyDescriptor$2(!call$5(propertyIsEnumerableModule.f, O, P), O[P]);
  };
  ...
  var require$$2$2 = /*@__PURE__*/getAugmentedNamespace(isObject$2);
  ...
  for (var COLLECTION_NAME in DOMIterables) {
    handlePrototype(globalThis$7[COLLECTION_NAME] && globalThis$7[COLLECTION_NAME].prototype, COLLECTION_NAME);
  }
  ...
  module.exports = function (Iterable, NAME, IteratorConstructor, next, DEFAULT, IS_SET, FORCED) {
    ...
    if ((!IS_PURE$3 || FORCED) && IterablePrototype[ITERATOR$2] !== defaultIterator) {
      defineBuiltIn$3(IterablePrototype, ITERATOR$2, defaultIterator, {
        name: DEFAULT
      });
    }
  ...
  fixRegExpWellKnownSymbolLogic('match', function (MATCH, nativeMatch, maybeCallNative) {
    ...
    function match(regexp) {
      ...
      var matcher = isObject$1(regexp) ? getMethod(regexp, MATCH) : undefined;
      return matcher ? call$3(matcher, regexp, O) : new RegExp(regexp)[MATCH](toString(O));
    },
  ...
  var trim = require('../internals/string-trim').trim;
  var NUMBER = 'Number';
  var NativeNumber = globalThis$5[NUMBER];
  ...
  var calledWithNew = function calledWithNew(dummy) {
    ...
    return isPrototypeOf$1(NumberPrototype, dummy) && fails$2(function () {
  ...
  module.exports = function () {
    ...
    if (classof$1(globalThis$4.process) === 'process') return 'NODE';
