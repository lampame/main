(function () {
    ...
    function main$5() {
      Lampa.Lang.add({
        ...
        lme_switchsource_modss_desc: {
          ru: "Приналичии Modss добавляет источники Filmix и KinoPub",
    ...
    function main() {
      var allSources = ['tmdb', 'cub', 'pub', 'filmix']; // Усі плеери
      var logos = {
      ...
      var sources = Lampa.Storage.get('lme_switchsource_modss') === true ? allSources : allSources.slice(0, 2); // Вибір джерел в залежності від умови
